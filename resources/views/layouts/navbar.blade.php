<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-success bg-gradient">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center">
        <div class="btn-group btn-group" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-primary btn-sm" title="Couches" id="layer_btn" onclick="openNav();"><span class="fa-solid fa-layer-group"></span> Couches</button>
            ...
            <button type="button" class="btn btn-secondary btn-sm" title="Polygone" onclick="openNavPolygone();" id="shape_btn"><span class="fa-solid fa-draw-polygon"></span> Polygone</button>
            ...
            <button type="button" class="btn btn-warning btn-sm" title="Actualiser la carte" onclick="reloadPage();"><span class="fa-solid fa-refresh"></span> Actualiser la carte</button>
        </div>
    </div>
    {{-- <div class="me-3">
