    ...
    <div id="sidebar" class="sidebar  bg-success bg-gradient">
        ...
        <div id="liste_couches">
            ...
            <div class="float-end mt-3 btn-group btn-group">
                <button type="button" class="btn btn-primary" title="Couches" id="rechercher" onclick="analyze_gis_data()"><span class="fa-solid fa-check"></span> Lancer l'analyse</button>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/web-gis.js') }}"></script>
